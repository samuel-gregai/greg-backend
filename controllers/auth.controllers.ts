...
import { sendHtmlRedirect } from "../utils/sendHTMLRedirect";
...
const googleResourceServer = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    const isLocalDev = process.env.NODE_ENV !== "production" || process.env.ALLOW_LOCAL_DEV === "true";
    ...
    sendHtmlRedirect(res, "https://web.gregthe.ai/actions", "Signing you into Greg...",100000);
  } catch (error:any) {
